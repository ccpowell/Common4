...
{
    public class ProfileChangeService : ChangeService, IProfileService
    {
        private IUserRepository UserRepository;

        public ProfileChangeService(IChangeTrackerRepository changeTrackerRepository, IUserRepository userRepository)
            : base(changeTrackerRepository)
        {
