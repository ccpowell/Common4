...
namespace DRCOG.Common.PersistenceSupport.SqlCeSupport
{
    ...
    {
        /// <summary>
        /// Returns either a new unopened <see cref="IDbConnection"/> or gets the connection
        /// associated with the current active transaction.
        /// </summary>
        /// <returns>An unopened <see cref="IDbConnection"/> or the connection associated with 
